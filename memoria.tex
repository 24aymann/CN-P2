...
Asimismo, se tiene el uso de \texttt{AWS Glue}, puesto que se ha demostrado la eficiencia que gana una arquitectura a través de jobs de ETL, procesos capaces de mover y transformar datos desde una o más fuentes hasta un destino final. Y lo más llamativo es que no requiere de aprovisionar una infraestructura física.
